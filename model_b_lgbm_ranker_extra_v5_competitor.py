...
train_path = DATA_DIR / "train_features_lean_extra_v5_competitor.parquet"
test_path = DATA_DIR / "test_features_lean_extra_v5_competitor.parquet"

submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_extra_v5_competitor.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_extra_v5_competitor.csv"

val_score_path = OUTPUT_DIR / "model_b_val_scores_extra_v5_competitor.csv"
test_score_path = OUTPUT_DIR / "model_b_test_scores_extra_v5_competitor.csv"
...
print("=" * 70)
print("EXTRA V5 COMPETITOR MODEL RESULT")
...
print("Training final v5 competitor model with n_estimators =", best_iter)
