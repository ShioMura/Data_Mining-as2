...
# New output file name, so it does not overwrite your current best immediately
submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_label_gain.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_label_gain.csv"
...
# ============================================================
# 5. Train LightGBM LambdaRank model with label_gain
# ============================================================
...
ranker = lgb.LGBMRanker(
    ...
    # Explicit gain mapping:
    # relevance labels are 0, 1, and 5.
    # This tells LightGBM that label 5 should have gain 5.
...
final_ranker = lgb.LGBMRanker(
    ...
    # Same label_gain as validation model
    label_gain=[0, 1, 2, 3, 4, 5],
