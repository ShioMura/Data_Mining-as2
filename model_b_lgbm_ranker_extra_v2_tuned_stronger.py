...
submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_extra_v2_tuned_stronger.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_extra_v2_tuned_stronger.csv"

val_score_path = OUTPUT_DIR / "model_b_val_scores_extra_v2_tuned_stronger.csv"
test_score_path = OUTPUT_DIR / "model_b_test_scores_extra_v2_tuned_stronger.csv"
...
# ============================================================
# 5. Train stronger tuned LightGBM LambdaRank model
# ============================================================
...
final_ranker = lgb.LGBMRanker(
    ...
    # Same stronger tuned parameters
