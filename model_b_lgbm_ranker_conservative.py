...
submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_conservative.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_conservative.csv"
...
# ============================================================
# 5. Train LightGBM LambdaRank model - conservative version
# ============================================================
...
final_ranker = lgb.LGBMRanker(
    ...
    # Same conservative parameters, but use best_n_estimators
