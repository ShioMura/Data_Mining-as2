...
submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_extra_v2_label_gain.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_extra_v2_label_gain.csv"

val_score_path = OUTPUT_DIR / "model_b_val_scores_extra_v2_label_gain.csv"
test_score_path = OUTPUT_DIR / "model_b_test_scores_extra_v2_label_gain.csv"
...
# ============================================================
# 5. Train label_gain LambdaRank model
# ============================================================
...
ranker = lgb.LGBMRanker(
    ...
    # relevance labels are 0, 1, 5
    # gain[0]=0, gain[1]=1, gain[5]=5
...
print("Training final label_gain model with n_estimators =", best_iter)
