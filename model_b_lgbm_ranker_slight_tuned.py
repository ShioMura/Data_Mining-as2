...
submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_slight_tuned.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_slight_tuned.csv"
...
# ============================================================
# 5. Train LightGBM LambdaRank model - slight tuned
# ============================================================
...
final_ranker = lgb.LGBMRanker(
    ...
    # Same slight-tuned parameters, but use best_n_estimators
