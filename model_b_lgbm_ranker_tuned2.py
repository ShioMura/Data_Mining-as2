...
submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_tuned2.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_tuned2.csv"
...
# ============================================================
# 5. Train LightGBM LambdaRank model - tuned2
# ============================================================
...
final_ranker = lgb.LGBMRanker(
    ...
    # Same tuned2 parameters, but use best_n_estimators
