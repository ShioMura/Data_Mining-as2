...
train_path = DATA_DIR / "train_features_lean_extra_v4_search_competition.parquet"
test_path = DATA_DIR / "test_features_lean_extra_v4_search_competition.parquet"

submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_extra_v4_search_competition.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_extra_v4_search_competition.csv"

val_score_path = OUTPUT_DIR / "model_b_val_scores_extra_v4_search_competition.csv"
test_score_path = OUTPUT_DIR / "model_b_test_scores_extra_v4_search_competition.csv"
...
# ============================================================
# 1. Load v4 search competition features
# ============================================================
...
print("=" * 70)
print("EXTRA V4 SEARCH COMPETITION MODEL RESULT")
...
print("Training final v4 search competition model with n_estimators =", best_iter)
