...
submission_path = OUTPUT_DIR / "submission_model_b_lgbm_ranker_lower_lr.csv"
importance_path = OUTPUT_DIR / "model_b_feature_importance_lower_lr.csv"
...
# ============================================================
# 5. Train LightGBM LambdaRank model - lower learning rate
# ============================================================
...
ranker = lgb.LGBMRanker(
    ...
    # Lower-learning-rate parameters
    n_estimators=1500,
    learning_rate=0.02,
    num_leaves=95,
...
final_ranker = lgb.LGBMRanker(
    ...
    # Same lower-learning-rate parameters, but use best_n_estimators
